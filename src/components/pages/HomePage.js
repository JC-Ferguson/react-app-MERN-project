    ...
    render() {
        ...
        return (
            <>
                ...
                <div className = {styles.progressionTracker}>
                    < ProgressionTracker headingStyle = {styles.head} blueStyle = {styles.blueLine} indent = { styles.indentLeft } logoStyle = {styles.logoStyle} />
                </div>
            </>
        )
    }
